...
import com.fliploan.guide.EMIs.PersonaloanEmi
import com.fliploan.guide.R
import com.fliploan.guide.config.Ads
import com.fliploan.guide.databinding.ActivityPersonalLoanInfoBinding
...
class PersonalLoanInfo : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding= ActivityPersonalLoanInfoBinding.inflate(layoutInflater)
        ...
        binding.backbtn.setOnClickListener { startActivity(Intent(this, PersonaloanEmi::class.java)) }
