...
import com.fliploan.guide.databinding.ActivityHomeLoanInfoBinding
...
class HomeLoanInfo : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding= ActivityHomeLoanInfoBinding.inflate(layoutInflater)
        ...
        binding.backbtn.setOnClickListener { startActivity(Intent(this, HomeloanEmi::class.java)) }
