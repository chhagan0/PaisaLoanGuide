...
import com.fliploan.guide.databinding.ActivityPayDayLoanInfoBinding
...
class PayDayLoanInfo : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding= ActivityPayDayLoanInfoBinding.inflate(layoutInflater)
        ...
        binding.backbtn.setOnClickListener { startActivity(Intent(this, PaydayLoanEmi::class.java)) }
nativeads()
