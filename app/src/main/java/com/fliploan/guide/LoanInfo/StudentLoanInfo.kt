...
import com.fliploan.guide.EMIs.PaydayLoanEmi
import com.fliploan.guide.EMIs.StudentLoanEmi
import com.fliploan.guide.R
import com.fliploan.guide.databinding.ActivityStudentLoanInfoBinding
...
class StudentLoanInfo : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding= ActivityStudentLoanInfoBinding.inflate(layoutInflater)
        ...
        binding.home.setOnClickListener { startActivity(Intent(this, AutoLoan::class.java)) }
        ...
        binding.backbtn.setOnClickListener { startActivity(Intent(this, StudentLoanEmi::class.java)) }
        binding.payday.setOnClickListener { startActivity(Intent(this, PaydayLoanEmi::class.java)) }
nativeads()
