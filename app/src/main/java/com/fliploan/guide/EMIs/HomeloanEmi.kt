...
import com.fliploan.guide.ApplyLoan.HomeLoan
import com.fliploan.guide.LoanInfo.HomeLoanInfo
...
import com.fliploan.guide.databinding.ActivityHomeloanEmiBinding
...
class HomeloanEmi : mainapp() {
    private lateinit var progress: ProgressDialog

    val binding: ActivityHomeloanEmiBinding? = null

    @RequiresApi(Build.VERSION_CODES.Q)
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding = ActivityHomeloanEmiBinding.inflate(layoutInflater)
