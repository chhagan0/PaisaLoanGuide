...
import com.fliploan.guide.LoanInfo.BusinessLoaninfo
...
import com.example.imp.ads.mainapp
 import com.fliploan.guide.databinding.ActivityBusinessLoanEmiBinding
...
class BusinessLoanEmi : mainapp() {
    private lateinit var progress: ProgressDialog

    var binding: ActivityBusinessLoanEmiBinding? = null

    @RequiresApi(Build.VERSION_CODES.Q)
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityBusinessLoanEmiBinding.inflate(layoutInflater)
