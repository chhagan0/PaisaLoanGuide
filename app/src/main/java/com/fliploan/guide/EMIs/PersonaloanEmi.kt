...
import com.fliploan.guide.ApplyLoan.PersonalLoan
import com.fliploan.guide.LoanInfo.PersonalLoanInfo
...
import com.fliploan.guide.databinding.ActivityPersonaloanEmiBinding
...
class PersonaloanEmi : mainapp() {
    private lateinit var binding: ActivityPersonaloanEmiBinding
    private lateinit var  progress: ProgressDialog

    @RequiresApi(Build.VERSION_CODES.Q)
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityPersonaloanEmiBinding.inflate(layoutInflater)
...
nativeads()
        ...
        binding.next.setOnClickListener {
            ...
            Handler(Looper.getMainLooper()).postDelayed({
                progress!!.dismiss()
                startActivity(Intent(this, PersonalLoanInfo::class.java))

                finish()
            }, 3000)
        }
        binding.backbtn.setOnClickListener { startActivity(Intent(this, PersonalLoan::class.java)) }
