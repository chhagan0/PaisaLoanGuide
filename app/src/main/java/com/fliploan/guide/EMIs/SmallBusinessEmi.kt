...
import com.fliploan.guide.ApplyLoan.SmallBusinessLoan
import com.fliploan.guide.LoanInfo.SmallBusinessInfo
import com.fliploan.guide.R
import com.fliploan.guide.ads.intertitial
import com.example.imp.ads.mainapp
import com.fliploan.guide.databinding.ActivitySmallBusinessEmiBinding
...
class SmallBusinessEmi : mainapp() {
    private lateinit var  progress: ProgressDialog

    var binding: ActivitySmallBusinessEmiBinding? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding = ActivitySmallBusinessEmiBinding.inflate(layoutInflater)
